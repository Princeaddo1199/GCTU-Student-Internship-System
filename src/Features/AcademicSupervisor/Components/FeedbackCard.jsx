...
export default function FeedbackCard({ studentName, type, date, comment, rating }) {
  return (
    <div className="feedbackCard">
      <div className="feedbackCardHeader">
        <div className="feedbackCardHeaderLeft">
          ...
          <span className="feedbackCardTypeBadge">{type}</span>
        </div>
      ...
      <div className="feedbackCardDate">{date}</div>
