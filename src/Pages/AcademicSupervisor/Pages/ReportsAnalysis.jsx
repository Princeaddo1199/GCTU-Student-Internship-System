...
export default function ReportsAnalysis() {
  ...
  const avgScore = (
    studentTable.reduce((acc, curr) => acc + curr.progress, 0) / totalStudents
  ).toFixed(1);
        ...
        <div className="reports-content performance-content">
          <div className="chart-card">
            ...
            <div className="chart-body">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart
                  data={performanceScoresWithNames}
          ...
          <div className="chart-card">
            ...
            <div className="chart-body">
              <ResponsiveContainer width="100%" height={300}>
                <LineChart
                  data={reportsData.progressTrend}
                  margin={{ top: 20, right: 30, left: 0, bottom: 5 }}
                >
                  <CartesianGrid
                    strokeDasharray="3 3"
            ...
            <div className="summary-list">
              ...
              <div className="summary-item">
                ...
                <span className="summary-value">
                  {reportsData.summaryStatistics.logbooksReviewed}
                </span>
              </div>
              <div className="summary-item">
                <span>Visits Completed</span>
                <span className="summary-value">
                  {reportsData.summaryStatistics.visitsCompleted}
                </span>
              </div>
              <div className="summary-item">
                <span>Evaluations Submitted</span>
                <span className="summary-value">
                  {reportsData.summaryStatistics.evaluationsSubmitted}
                </span>
              </div>
            </div>
          </div>
