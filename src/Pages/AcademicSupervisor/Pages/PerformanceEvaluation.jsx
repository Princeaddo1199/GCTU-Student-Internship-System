  ...
  return (
    <>
      <div className="performanceEvaluationTitle">
        <h2 className="performanceEvaluationTitleMain">
          ...
          <div className="selectStudentOption">
            ...
            <div className="ratingContainer">
              <Rating
                ...
                rating={ratings["Technical Skills"]}
                onChange={(val) => handleRatingChange("Technical Skills", val)}
              />
              <Rating
              ...
              <Rating
                ...
                rating={ratings["Problem Solving"]}
                onChange={(val) => handleRatingChange("Problem Solving", val)}
              />
              <Rating
                skills="Teamwork"
